...
(function (aufgabe10) {
    ...
    */
    ...
    function drawListToDOM() {
        ...
        for (let index = 0; index < aufgabe10.todos.length; index++) {
             ...
             */
            todo.innerHTML = "<span class='check " + aufgabe10.todos[index].ListChecked + "'><i class='fas fa-check'></i></span>"
    ...
    function updateCounter() {
        ...
        let counterOpen = 0;
        for (let i = 0; i < aufgabe10.todos.length; i++) {
            console.log(aufgabe10.todos[i].ListChecked);
            if (aufgabe10.todos[i].ListChecked == true) {
                counterChecked++;
            }
            else {
                counterOpen++;
    ...
    */
    function addTodo() {
        ...
        if (inputDOMElement.value != "") {
            ...
            aufgabe10.todos.unshift({ text: inputDOMElement.value, ListChecked: false });
    ...
    */
    function toggleCheckState(index) {
        ...
        aufgabe10.todos[index].ListChecked = !aufgabe10.todos[index].ListChecked;
        /**
         * Die zentrale Funktion, um die Liste des ToDo-Arrays in den DOM zu rendern
         * wird wieder getriggert
         */
