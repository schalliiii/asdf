...
const boo = document.querySelector("#boobutton"); // speichert den boobutton
const laugh = document.querySelector("#laughbutton"); // speichert den laughbutton
const duck = document.querySelector("#duckbutton"); // speichert den duckbutton
const boing = document.querySelector("#boingbutton"); // speichert den boingbutton
const applause = document.querySelector("#applausebutton"); // speichert den applausebutton
...
const soundButtons = [boo, laugh, duck, boing, applause];
...
addLevelListeners();
onButton.addEventListener('click', function (oEv) {
